...
public class LandingSpot:MonoBehaviour{
    ...
    public void RotateBird(){
        ...
        rotE.y = Mathf.LerpAngle(landingChild._thisT.rotation.eulerAngles.y, 
            _thisT.rotation.eulerAngles.y, lerpCounter * Time.deltaTime * 
            _controller._landedRotateSpeed);  		

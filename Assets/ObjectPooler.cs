...
public class ObjectPooler : MonoBehaviour
{
    ...
    public GameObject GetPooledObject(int index)
    {
        ...
        if (itemsToPool[index].shouldExpand)
        {
            ...
            GameObject obj = (GameObject)Instantiate(itemsToPool[index].objectToPool, transform, false);
            obj.SetActive(false);
    ...
    void ObjectPoolItemToPooledObject(int index)
    {
        ...
        {
            GameObject obj = (GameObject)Instantiate(item.objectToPool, transform, false);
            obj.SetActive(false);
